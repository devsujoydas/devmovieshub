  ...
  return (
    <header className="fixed w-full bg-[#0a030394] z-10 top-0 shadow shadow-[#2e2c2c] font-montserrat ">
      ...
      <div className="text-[#B4BECC] lg:mx-40 flex flex-col lg:flex-row lg:gap-10 gap-5 justify-between md:items-center  md:py-3 py-3">
        ...
        <div className="flex justify-between items-center gap-10 w-full lg:w-fit lg:px-0 px-5">
          ...
          <div onClick={() => setHumbarger(!humbarger)} className="lg:hidden block text-4xl text-secondary shadow-2xl">
            <LuMenu />
          </div>
        </div>

        {/* nav for large device */}
        <div className="hidden lg:block bg-[#0F0F0F] lg:p-2 rounded-md">
          <Nav />
        </div>


        <div className="text-3xl hidden lg:flex items-center justify-center gap-5  text-white">
          ...
          <div className="w-10 cursor-pointer active:scale-95 transition-all ">
            <img className="w-full rounded-full " src="/public/default.jpg" alt="" />
          </div>
        </div>
        ...
        <div className={
          humbarger
            ?
            'lg:hidden fixed z-20 top-0 -left-12/12 w-full h-screen grid grid-cols-5 opacity-0 duration-700 transition-all'
            :
            'lg:hidden opacity-100 fixed z-20 top-0 left-0 w-full h-screen grid grid-cols-5 duration-700 transition-all'
        } >
